...
class LeaveListScreen extends StatefulWidget {
  const LeaveListScreen(
      {super.key, this.initialFilter = 'all', this.initialMonth});
...
class _LeaveListScreenState extends State<LeaveListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context
          .read<LeaveViewModel>()
          .loadLeaves(widget.initialFilter, month: widget.initialMonth),
    );
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              const CustomAppBar(title: 'Leave List'),
    ...
    return CardContainer(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text('${leave.leaveMode} Application',
          ...
          SizedBox(height: 4 * s),
          Text(leave.startDate.isEmpty ? 'Date not available' : leave.startDate,
